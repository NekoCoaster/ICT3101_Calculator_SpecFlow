namespace ICT3101_Calculator.UnitTests
{
    public class CalculatorTests
    {
        ...
        public void GenMagicNum_WithValidInput_ReturnsExpectedResultParameterized(double input, double expectedValue)
        {
            ...
            // Act
            double result = _calculator.GenMagicNum(input, filePath);
        ...
        [Test]
        public void GenMagicNum_WithInputOutOfRangeHigh_ReturnsZeroOrHandlesGracefully()
        {
            // Arrange
            ...
            // Assert
            // Depending on your function's behavior, adjust the expected value
            Assert.That(result, Is.EqualTo(0));
        }

        [Test]
        public void GenMagicNum_WithNegativeInput_ReturnsZeroOrHandlesGracefully()
        {
            // Arrange
            double input = -1;
            string filePath = "MagicNumbers.txt";
        ...
        public void GenMagicNum_WithMissingFile_ThrowsFileNotFoundException()
        {
            ...
            // Act & Assert
            Assert.Throws<FileNotFoundException>(() => _calculator.GenMagicNum(input, filePath));
        }
